...
Vue.prototype.link = 'http://qebb.qiebbyc.com/api/' + config.bizId 
// Vue.prototype.link = 'http://172.16.1.66:83/api/' + config.bizId
...
http.post('/amoy/app/design', {
   ...
   if (res.data.content) {
     for (let i = 0; i < content.length; i++) {
       if (content[i].name === 'edit-header') {         store.commit('setSearch', content[i].params)
