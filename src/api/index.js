...
// 生成订单 group
export const groupInterim = function (goodsId, goodsNum, attrId, color, size) {
  return http.post(mall + '/cart/interim', {goodsId, goodsNum, attrId, color, size}, true)
}
// 查询订单
export const cardCheckout = function (type, goodsInfo,groupType) {
  return http.post(mall + '/cart/checkout', {type, goodsInfo,groupType}, true)
}
// 添加购物车
...
// 创建订单
export const orderCreate = function (goodsInfo, note, deduce,oilCard,groupType,addGroup,GroupId,coupon) {
  return http.post(mall + '/order/create', {goodsInfo: goodsInfo, note: note, deduce,oilCard,groupType,addGroup,GroupId,coupon }, true)
}
// 订单记录
...
//二手订单买单
export const buyOrderList = function (page, status) {
  return http.post(mall + '/second-goods/buy-order-list', {page, status})
}
//二手订单 卖单
export const sellOrderList = function (page, status) {
  return http.post(mall + '/second-goods/sell-order-list', {page, status})
}
//二手退货
export const orderApplyReturn = function (orderId, content, img) {
  return http.post(mall + '/second-goods/buy-return-order', {orderId, content, img})
}
// 删除订单
...
//二手删除订单
export const secondOrderRemove = function (orderSn) {
  return http.post(mall + '/second-goods/buy-remove', {orderSn}, true)
}
//二手商家是否同意退货
export const isAgreeReturn = function (orderId,type) {
  return http.post(mall + '/second-goods/sell-return-order', {orderId,type}, true)
}
//二手确认收货
export const secondConfirmGood = function (orderId) {
  return http.post(mall + '/second-goods/buy-confirm-order', {orderId}, true)
}
//二手订单删除
export const delbuyOrder = function (orderId) {
  return http.post(mall + '/second-goods/buy-delete', {orderId}, true)
}
// 二手发货
export const secondSendGoood = function (orderId,expressName,expressNo) {
  return http.post(mall + '/second-goods/sell-send-goods', {orderId,expressName,expressNo}, true)
}
// 商品分类
...
//二级分类数据
export const secondList = function (cid,model) {
  return http.post(mall + '/second-goods/goods-list', {cid,model}, true)
}
...
//二手订单详情 
export const goodsOrderDetaiil = function (orderId,type) {
  return http.post(mall + '/second-goods/order-details', {orderId,type}, true)
}
...
//快递 进程
export const secondLogisticsInfo = function (orderSn) {
  return http.post(mall + '/order/second-express-info', {orderSn})
}
...
// 支付宝提现
export const creditWithdraw = function (type, price, username, mobile, alipay, withdrawType,creditType,) {
  return http.post(mall + '/credit/credit-withdraw', {type, price, username, mobile, alipay, withdrawType,creditType})
}
// 银行卡提现
export const creditCard = function (type, price, username, mobile, bankCard, bankName, bankNameNo, withdrawType,creditType) {
  return http.post(mall + '/credit/credit-withdraw', {type, price, username, mobile, bankCard, bankName, bankNameNo, withdrawType,creditType})
}
// 银行卡提现
export const creditNew = function (creditType) {
  return http.post(mall + '/credit/credit-withdraw', {creditType}, true)
}
// 提交退款资料
...
export const indexBanner = function (model) {
  return http.post(mall + '/second-goods/index', {model}, true)
}
//导航
export const underShopNav = function (model) {
  return http.post(mall + '/index/category', {model}, true)
}
