    ...
    <div v-if="show">
      <div class="register_list input_list">
        ...
        <div class="label5">
          ...
          <span @click="clip" class="clip" style="background: #01C2C7">一键粘贴</span>
        </div>
        <div class="label3">
        ...
        <p>
          ...
          登录注册即表示同意
          <span @click="jumpTo('/about?title=用户使用协议&type=7')" style="color:#01C2C7">《用户使用协议》</span>
        </p>
        <div class="edit_button">
          <button class="btn_bright_red" style="background: #01C2C7" @click="send">完成</button>
        </div>
      </div>
    </div>
  </div>
