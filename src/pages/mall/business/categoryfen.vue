  ...
  <div class="category">
    ...
    <div class="mescrollBox">
      <mescroll-vue ref="mescroll" :down="mescrollDown" :up="mescrollUp" @init="mescrollInit">
        <Business style="margin-top: .88rem" :list="suggest" @jump="seller"></Business>
        <div id="d24"></div>
      </mescroll-vue>
    </div>
  </div>
...
<script>
  ...
  import Business from '../business/business1'
  ...
  export default {
    ...
    methods: {
      ...
      upCallback (page, mescroll) {
        //   console.log('route.query.type',this.$route.query.type)
