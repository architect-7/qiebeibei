      ...
      <div class="detail_main" id="detail_main" ref="my_scroller">
        <div class="banner" style="position:relative">
          ...
          <div class="title">
            ...
            <div class="price_main ticket_p"><span>{{detailObj.integral}}积分+{{detailObj.ex_price}}元</span>
            <!--<del style="font-size: 0.25rem; font-weight: normal; color: #ccc; margin-left: 0.2rem">¥{{detailObj.spe_price}}</del>-->
            </div>
            <div class="bottom">
              <div>配送方式：{{detailObj.freeShippingInfo}}</div>
              <div>已兑换：{{detailObj.sales}}</div>
    ...
    <div v-transfer-dom>
      <popup v-model="show_select" position="bottom"  width="100%">
        <div class="detail_model">
              ...
              <div class="header_main">
                ...
                <div class="right_main">
                  <div class="div1" v-if="active1 != 0 || active2 != 0">
                    <span>¥</span>{{detailObj.integral}}积分+{{price}}元
                  </div>
                  <div class="div1" v-if="active1 == 0 && active2 == 0">
                    <span>¥</span>{{detailObj.integral}}积分+{{price}}元
                  </div>
            ...
            <div class="num_main num_sel">
             <!-- <x-number title="数量" v-model="changeValue" width="0.5rem" :min="1" button-style="round" fillable ></x-number>-->
             <div>数量</div>
             <div>{{changeValue}}</div>
            </div>
...
export default {
  ...
  data () {
    return {
      ...
      deduce:this.$route.query.deduce,
      show_select: false,
      changeValue: 1,
      buy_select: false,
      detailObj: {},
