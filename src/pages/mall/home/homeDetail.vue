<template>
  <div class="home_detail" style="height:100%;">
    ...
    <div class="footer">
      <div class="left">
        <div class="div_flex" @click="jumpTo({name:'home'})">
    ...
    <div v-if="isShowQrcode">
      <div class="mall-sq-body">
        <div class="sq-content">
          <div class="sq-one">
            <img src="../../../assets/mall/img/under/jifenbj.png" alt="">
          </div>
          <div class="sq-two">
  ...
  methods: {
    ...
    getCollectNum(){
      this.$http.post('/amoy/user/collection', {
          origin_id: this.$route.query.title,
          status: 2,
          coupon_money:  0,
          good_image: this.detailObj.thumb,
          sales_num: this.detailObj.sales,
          item_url: 'ybb',
          coupon_price: this.detailObj.spe_price,
          origin_price: this.detailObj.marketprice,
          commission_money:'0.00',
          level_commission_money: '0.00',
          title: this.detailObj.goodsName,
          type: '1'
        }, true).then(res => {
