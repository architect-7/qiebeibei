    ...
    <div class="firmOrder_main">
            ...
            <div class="list">
              ...
              <div class="li_main">
                ...
                <div class="title_right_red">
                  <span></span>{{items.goods[0].integral}}积分+{{items.shopInfo.countPrice}}元
                </div>
              </div>
            </div>
          </div>
      ...
      <div class="footer">
          <div class="footer_main">
            <div class="div1">
              <label></label><span>{{obj.cartList[0].goods[0].integral}}积分</span> + <span>{{sumPrice}}元</span>
            </div>
    ...
    getDetail (type, data) {
      apiHttp.cardCheckout(type, data).then(response => {
        if (response.code === 0) {
          ...
          this.ticket = response.data.cartList[0].goods[0].integral
