<template>
  <div id="home" class="homeMall">
    ...
    <div class="seach_main" v-if="$store.state.global.mallSearch" :style="{paddingTop: (statusH + 0.2) + 'rem',background: 'linear-gradient('+$store.state.global.mallSearch.bgDeg+'deg,' +$store.state.global.mallSearch.bgColor+','+$store.state.global.mallSearch.bgSecondColor+')'}">
      <div class="home_seach">
        <div class="home_seach_left backBox">
          ...
          <!--@click="jumpTo({name:'mall/home'})" v-if="$store.state.global.firstNav === '/home'"-->
        ...
        <mescroll-vue ref="mescroll" :down="mescrollDown" :up="mescrollUp" @init="mescrollInit">
          <div class="home_main">
            <template v-for="item of $store.state.global.mallContent">
              ...
              <!-- 轮播图 -->
              <edit-slide v-if="item.name === 'edit-slide'"  :data="item.params" ref="editSlide" @swiperChange="swiperChange" :key="item.id" ></edit-slide>
              <!-- 横向轮播页面 -->
    ...
    <!-- <img src="../../../assets/mall/shouye.png" alt="" v-if="$store.state.global.firstNav === '/home'" class="homeBack" @click="jumpTo({name:'mallHome'})"> -->
...
import oliIndex from '../../my/oliindex'
export default {
  name: 'index',
  data () {
    return {
