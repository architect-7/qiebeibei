      ...
      <div class="cart">
        ...
        <div class="cart-foot" v-if="showFoot && list">
            ...
            <div class="right">
              ...
              <div style="background:#01C2C7" @click="jumpTo({name:'mallFirmOrder',query:{type:'cart'}})">结算</div>
            </div>
        </div>
        <div class="cart-foot" v-if="!showFoot && list">
          ...
          <div class="right">
            <div style="background:#01C2C7" @click="send('delete')">删除</div>
          </div>
        </div>
        <div v-if="mask">
          <confirm v-model="mask"
          title="商品操作"
          @on-cancel="onCancel"
...
import { Panel, XHeader, InlineXNumber, XNumber ,Confirm } from 'vux'
