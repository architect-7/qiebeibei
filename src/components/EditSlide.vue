<template>
  <div id="swiper">
   <!--<div class="swiperBox" v-if="!data.style || data.style === '0'" :style="{backgroundColor: data.bgColor}">
    ...
    <div class="swiperBox2"   :style="{backgroundColor: data.bgColor}">
      <swiper :options="swiperOption3" class="swiper2" ref="swiperBox2" >
        <swiper-slide v-for="(item, index) in data"  :key="index">
          <img :src="item.thumb" alt=""  @click="jumpLink(item.link)">
        </swiper-slide>
