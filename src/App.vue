...
export default {
  ...
  data () {
    return {
      ...
      colors: '',
      r: true,
      hideTitle: ['home', 'clockIn','olimon', 'mallUnderShopDetail', 'paySuccess', 'mallUnderShop', 'mallTradSale', 'regulation', 'clockInDetail', 'mallHome', 'sort', 'classify', 'newIndex', 'otherclassify', 'supergoods', 'supergoods2', 'goods', 'likegoods', 'fansDetail', 'materials', 'materials1', 'materials2', 'my', 'my1', 'my2', 'my3', 'super', 'team', 'mallMy', 'guide', 'mallSeller', 'fastrob', 'signIn', 'mallUnderGoodsDetails'],
      version: '',
      smart: '',
